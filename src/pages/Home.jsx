    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE AFRICA ', 'CELEBRATES', ' IN STYLE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'CELEBRATES' ? 700 : 300,
                }}
              >
                {line}
              </h1>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Great Africa Events &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['WEDDINGS', 'CORPORATE GALAS', 'BIRTHDAYS', 'CONFERENCES', 'FLORAL DESIGN', 'CUSTOM DECOR'];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80', 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80', 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&q=80', 'https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80', 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80', 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&q=80'];
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Great Africa Events showcase"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Great Africa Events detail"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Award-Winning Design', desc: 'Recognized across Zimbabwe for creative excellence and innovation in event styling.' },
    { title: 'Bespoke Approach', desc: 'No templates, no shortcuts. Every event is designed from scratch to reflect your unique vision.' },
    { title: 'End-to-End Service', desc: 'From initial concept sketches to on-site installation and post-event breakdown. We handle everything.' },
    { title: 'Cultural Sensitivity', desc: 'We honour African traditions while bringing modern design excellence to every celebration.' }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              alt="Great Africa Events quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Great</span>
            </h2>
